...
`dev` runs your reflexes against a command and prints the verdict, so you can iterate without re-triggering the agent. See the full types in the [spec](/docs/reference/spec).
